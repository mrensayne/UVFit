...
$update.click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "http://ec2-35-172-134-252.compute-1.amazonaws.com:3000/home.html/user/update",
...
$remdevbtn.click(function () {
    ...
    $.ajax({
        type: "DELETE",
        url: "http://ec2-35-172-134-252.compute-1.amazonaws.com:3000/home.html/user/removeDev",
...
$newPassSubmit.click(function () {
    ...
    if (good) {
        ...
        $.ajax({
            type: "POST",
            url: "http://ec2-35-172-134-252.compute-1.amazonaws.com:3000/home.html/user/passChange",
            headers: request,
